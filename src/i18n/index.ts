...
export type Translation = {
  ...
  about: { title: string; p1: string; p2: string; p3: string; resume: string };
  skills: { title: string; subtitle: string; categories: { frontend: string; backend: string; design: string; devops: string } };
  projects: { title: string; subtitle: string; loading: string };
  experience: { title: string; subtitle: string; education: string; eduSubtitle: string };
