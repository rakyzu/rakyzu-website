...
export const id: Translation = {
  ...
  hero: {
    ...
    description: "Menciptakan pengalaman digital dengan kode bersih dan desain yang matang.",
    cta1: "Lihat Proyek",
    cta2: "Hubungi Saya",
  },
  about: {
  ...
  projects: {
    title: "Proyek",
    subtitle: "Hal-hal yang telah saya buat",
    loading: "Memuat...",
  },
  experience: {
    title: "Pengalaman",
  ...
  guestbook: {
    title: "Buku Tamu",
    subtitle: "Tinggalkan pesan",
    name: "Nama kamu",
    message: "Tulis sesuatu...",
    sign: "Tanda tangan",
  },
  contact: {
    title: "Kontak",
